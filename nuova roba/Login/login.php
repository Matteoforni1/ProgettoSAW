...
<body style="background-color:#ffffff;">
    <?php
	     ...
	     /*if (isset($_SESSION["id"]) || isset($_SESSION["adminid"])){
			 $_SESSION["errore"]="Prima di accedere ad un altro account devi eseguire il logout";
	...
	<div class="register" >
	     <button type="button" class="registerbutton" onclick="location.href='../Registrazione/Registrazione.php';">Registrati</button>
	</div>
	</br>
	<div class="footer" style="color:black; background-color:#f4f4f4; box-shadow: rgba(0, 0, 0, 0.17) 0px -23px 25px 0px inset, rgba(0, 0, 0, 0.15) 0px -36px 30px 0px inset, rgba(0, 0, 0, 0.1) 0px -79px 40px 0px inset, rgba(0, 0, 0, 0.06) 0px 2px 1px, rgba(0, 0, 0, 0.09) 0px 4px 2px, rgba(0, 0, 0, 0.09) 0px 8px 4px, rgba(0, 0, 0, 0.09) 0px 16px 8px, rgba(0, 0, 0, 0.09) 0px 32px 16px; height:24em;">
	<p>LOREM IPSUM</p>
	</div>
