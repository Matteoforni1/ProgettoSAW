...
<body  style="background-color:#ffffff;">	
	...
	<div class="reg_form_box">
	    <form id="reg_form" action="user_registration.php" method="post">
		    ...
		    <input type="text" id="firstname" name="firstname" placeholder="Nome" class="reg_form_input">
			</br>
			<label for="lastname"><b>Cognome</b></label>
			</br>
		    <input type="text" id="lastname" name="lastname" placeholder="Cognome" class="reg_form_input">
			</br>
			<label for="email"><b>E-mail</b></label>
			</br>
		    <input type="email" id="email" name="email" placeholder="E-mail" class="reg_form_input">
			</br>
			<label for="password"><b>Password</b></label>
			</br>
		    <input type="password" id="pass" name="pass" placeholder="Password" class="reg_form_input">
			</br>
			<label for="confirm"><b>Conferma Password</b></label>
			</br>
		    <input type="password" id="confirm" name="confirm" placeholder="Conferma Password" class="reg_form_input">
			</br>
